            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="firstname" class="col-sm-3 control-label">Nama Calon</label>
                ...
                <div class="form-group">
                    <label for="lastname" class="col-sm-3 control-label">Kandidat</label>
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Jabatan</label>
                ...
                <div class="form-group">
                    <label for="platform" class="col-sm-3 control-label">visi misi</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Nama Calon</label>
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">Kandidat</label>
                ...
                <div class="form-group">
                    <label for="edit_platform" class="col-sm-3 control-label">visi misi</label>
